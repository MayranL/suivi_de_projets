...
class DashboardSmallPage extends StatefulWidget {
  const DashboardSmallPage({Key? key}) : super(key: key);

  @override
  State<DashboardSmallPage> createState() => DashboardSmallPageState();
}

class DashboardSmallPageState extends State<DashboardSmallPage> {
  @override
